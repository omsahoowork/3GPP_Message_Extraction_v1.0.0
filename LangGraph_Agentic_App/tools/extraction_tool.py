...
from config import CONTEXT_TEMPLATE_PATH
...
def _get_extraction_llm(llm_provider: str = "", llm_model: str = ""):
...
def query_enhancement_rag(
    ...
    llm_provider: Annotated[str, "Selected LLM provider for this run."] = "",
    llm_model: Annotated[str, "Resolved LLM model for this run."] = "",
) -> str:
    ...
    """
    llm = _get_extraction_llm(llm_provider=llm_provider, llm_model=llm_model)
