...
def load_state_alias_map(rat: str) -> dict[str, str]:
...
def extract_state_key_from_ue_state(ue_state: str, rat: str) -> str:
    ...
    alias_map = load_state_alias_map(rat)
    normalised_text = normalise_state_key(text_upper)
